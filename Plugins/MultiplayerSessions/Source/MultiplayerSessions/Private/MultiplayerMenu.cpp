...
void UMultiplayerMenu::OnCreateSession(bool bWasSuccessful)
{
	if (bWasSuccessful)
	{
		if (GEngine)
		{
			GEngine->AddOnScreenDebugMessage(-1, 10.f, FColor::Magenta, FString(TEXT("Session Created Successfully :)")));
		}
...
void UMultiplayerMenu::MultiplayerMenuTearDown()
{
	RemoveFromParent();
